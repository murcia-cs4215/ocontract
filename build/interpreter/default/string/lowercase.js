...
exports.lowercase = new closure_1.DefaultClosure((0, utils_1.makeFunctionType)(utils_1.stringType, utils_1.stringType), 1, (args) => {
    (0, assert_1.default)(args[0].value instanceof wrappers_1.StringWrapper);
    const value = args[0].value.unwrap();
    return {
        value: new wrappers_1.StringWrapper(value.toLocaleLowerCase()),
