...
export interface GrammarVisitor<Result> extends ParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitLetGlobalBindingExpression?: (ctx: LetGlobalBindingExpressionContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitFunctionDeclarationExpression?: (ctx: FunctionDeclarationExpressionContext) => Result;
