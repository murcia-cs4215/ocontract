...
import { ContractsListContext } from './GrammarParser';
...
export interface GrammarListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by `GrammarParser.contractsList`.
   * @param ctx the parse tree
   */
  enterContractsList?: (ctx: ContractsListContext) => void;
  /**
   * Exit a parse tree produced by `GrammarParser.contractsList`.
   * @param ctx the parse tree
   */
  exitContractsList?: (ctx: ContractsListContext) => void;
   ...
   * @param ctx the parse tree
   */
  enterIdentifierWithContextParen?: (
   ...
   * @param ctx the parse tree
   */
  exitIdentifierWithContextParen?: (
    ctx: IdentifierWithContextParenContext,
  ) => void;
   ...
   * @param ctx the parse tree
   */
  enterIdentifierListWithContext?: (
    ctx: IdentifierListWithContextContext,
  ) => void;
  /**
   * Exit a parse tree produced by `GrammarParser.identifierListWithContext`.
   * @param ctx the parse tree
   */
  exitIdentifierListWithContext?: (
    ctx: IdentifierListWithContextContext,
  ) => void;
